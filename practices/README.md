...
本目录记录在实际部署和运维中积累的使用经验、配置建议和设计决策。

## 索引

| 文件 | 主题 |
|---|---|
| [routing-strategy.md](routing-strategy.md) | llm-d 路由策略选择与多策略并存 |
...
| [precise-prefix-routing.md](precise-prefix-routing.md) | 精准前缀缓存路由工作原理：ZMQ 事件、block hash、倒排索引、评分流程 |
